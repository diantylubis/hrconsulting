...
@section('styling')
<link rel="stylesheet" href="{{ url('landing-page1/style.css') }}">
@endsection
        ...
        <div class="container">
            <div class="row pinarik1">
                ...
                <div class="col-lg-6 col-sm-12 px-5">
                    <img src="landing-page1/image/image3.png" class="img-gambar">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section1 mt-5">
        <div class="container">
            <div class="row pinarik1">
                ...
                <div class="col-lg-6 col-sm-12 px-5">
                    <img src="landing-page1/image/image4.png " class="img-gambar">
                </div>
            </div>
        </div>
    </div>
